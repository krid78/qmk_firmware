...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = KEYMAP( /* Basic Mac QWERTZ */
        ...
        F(0),    DE_Q,    DE_W, DE_E, DE_R, DE_T, DE_Z, DE_U, DE_I, DE_O,    DE_P,   DE_UE,   DE_PLUS, DE_PIPE, \
        MO(1),   DE_A,    DE_S, DE_D, DE_F, DE_G, DE_H, DE_J, DE_K, DE_L,    DE_OE,  DE_AE,   DE_HASH, KC_ENT, \
        KC_LSFT, DE_LESS, DE_Y, DE_X, DE_C, DE_V, DE_B, DE_N, DE_M, DE_COMM, DE_DOT, DE_MINS, KC_ENT,      KC_RSFT, \
